...
export default function Sidebar() {
  ...
  <a href="/" className="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium hover:bg-orange-300">
    <FiGrid className="h-6 w-6" />Dashboard
  </a>
  <a href="/profile" className="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium hover:bg-orange-300" >
